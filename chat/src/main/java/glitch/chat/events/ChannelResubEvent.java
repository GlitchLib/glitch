...
public class ChannelResubEvent extends AbstractEvent<GlitchChat> implements IEvent<GlitchChat>, IDObject<String> {
    ...
    public ChannelResubEvent(GlitchChat client, Message message) {
        ...
        this.months = message.getTags().getInteger("msg-param-months");
    }
