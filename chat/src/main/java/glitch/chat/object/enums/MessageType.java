package glitch.chat.object.enums;
...
public enum MessageType {
     ...
     * <p>
     * (Note: These three “followers” tags are broadcast to a channel, when a moderator makes changes.)
     */
    FOLLOWERS_OFF,
    ...
    /**
     * Your tagline is too long! Try again with a tagline of &lt;number&gt; characters or less.
     */
    HOST_TAGLINE_LENGTH_ERROR,
     ...
     * <p>
     * (Note: These 3 “msg_followers” tags are kickbacks to a user who does not meet the criteria; i.e., does not follow or has not followed long enough.)
     */
    MSG_FOLLOWERSONLY,
    ...
    /**
     * Usage: “/host &lt;channel&gt; [tagline]” - Host another channel. Tagline (optional, max &lt;number&gt; characters) is shown to viewing parties. Use “/unhost” to unset host mode.
     */
    USAGE_HOST,
