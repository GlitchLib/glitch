...
public class PubSubConverter implements IEventConverter<GlitchPubSub> {
    private final Gson gson;

    PubSubConverter(Gson gson) {
        this.gson = gson;
    }

    @Override
    public IEvent<GlitchPubSub> convert(GlitchPubSub client, String raw) {
        return new PubSubEvent(client, gson, gson.toJsonTree(raw).getAsJsonObject());
    }

//    @Override
//    public IEvent<GlitchPubSub> convert(ByteString value, GlitchPubSub client) {
//        JsonElement r = gson.toJsonTree(value.utf8());
...
//
//        public WhisperMode(Type type, String data) {
//            this.type = type;
//            this.data = data;
//        }
//
